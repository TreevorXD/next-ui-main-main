...
import { Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Button, Accordion, AccordionItem } from "@nextui-org/react";
                                                    ...
                                                    <DropdownMenu
                                                        ...
                                                        onAction={(key) => {
                                                            if (key === 'delete') {
                                                                ...
                                                                exportServerData(item); // Call export function with item data
                                                            }
                                                        }}
                                                    >
